    ...
    <div class="container-fluid mt-4 isi">
        ...
        <div class="d-flex flex-row-reverse mb-3">
            <button type="button" class="btn btn-primary">
                <a href="<?= BASEURL; ?>/admin/tambah_alternatif" class="text-white"><span class="fw-bold">+</span> Tambah Data</a>
            </button>
            <button type="button" class="btn btn-success me-2">
                <a href="<?= BASEURL; ?>/admin/import" class="text-white">Import Excel</a>
            </button>
            <button type="button" class="btn btn-success me-2">
                ...
                <tbody>
                    ...
                    <?php for ($i = 0; $i < count($data['alternatif']); $i++) : ?>
                        <tr>
                            ...
                            <?php endfor; ?>
                            <td>
                                <a href="<?= BASEURL; ?>/admin/hapus_alternatif/<?= $data['alternatif'][$i]['id'] ?>" class="badge text-bg-danger  ml-1" onclick="return confirm('Yakin ingin menghapus kriteria')">hapus</a>
                                <a href="<?= BASEURL; ?>/admin/ubah_alternatif/<?= $data['alternatif'][$i]['id'] ?>" class="badge text-bg-success ubahAlternatif">ubah</a>
                            </td>
                        </tr>
                    <?php endfor; ?>
                </tbody>
