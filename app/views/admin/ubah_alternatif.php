    ...
    <div class="container-fluid mt-4 isi">
        <div class="shadow rounded-2 bg-light p-3">
            ...
            <div class="d-flex flex-row mt-3 mb-4">
                ...
                <a href="<?php echo BASEURL; ?>/admin/alternatif" class="ms-auto">
                    <button type="button" class="btn btn-secondary">Kembali</button>
                </a>
            </div>

            <form action="<?php echo BASEURL; ?>/admin/ubah_data_alternatif" method="post">
                <div class="row">
                    <div class="col-6">
                        <label for="no_urut" class="form-label">Nomor Urut</label>
                        <input type="number" class="form-control" id="no_urut" aria-describedby="emailHelp" name="no_urut" autocomplete="off" required value="<?= $data['alternatif']['no_urut'] ?>">
                    </div>
                    <div class="col-6">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="nama" aria-describedby="emailHelp" name="nama" autocomplete="off" required value="<?= $data['alternatif']['nama'] ?>">
                    </div>
                    <div class="col-6">
                        <label for="club" class="form-label">Klub</label>
                        <input type="text" class="form-control" id="club" aria-describedby="emailHelp" name="club" autocomplete="off" required value="<?= $data['alternatif']['club'] ?>">
                    </div>
