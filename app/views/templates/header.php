        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-link">
                    ...
                    <hr>
                    <li class="nav-link mt-4">
                        <a href="<?php echo BASEURL; ?>/admin/data_kriteria">
                            <i class='bx bxs-cylinder icon'></i>
                            <span class="text nav-text">Kriteria</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="<?php echo BASEURL; ?>/admin/subkriteria">
                            <i class='bx bxs-coin-stack icon'></i>
                            <span class="text nav-text">Sub Kriteria</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="<?php echo BASEURL; ?>/admin/alternatif">
                            <i class='bx bxs-group icon'></i>
                            <span class="text nav-text">Data Peserta Ujian</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="<?php echo BASEURL; ?>/admin/hasil">
                            <i class='bx bx-bar-chart-alt icon'></i>
                            <span class="text nav-text">Hasil Peringkat</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="<?php echo BASEURL; ?>/admin/data_analisis">
                            <i class='bx bx-bar-chart-alt icon'></i>
                            <span class="text nav-text">Data Analisis</span>
                        </a>
                    </li>
                    <li class="nav-link">
                        <a href="<?php echo BASEURL; ?>/admin/data_perhitungan">
                            <i class='bx bx-bar-chart-alt icon'></i>
